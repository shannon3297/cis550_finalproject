...
class Industries extends React.Component {
    ...
    getIndustriesMostVolatility(date) {
        console.log("fetching industries volatility", date)
        fetch(SERVER_URL + "/industriesMostVolatility" + (date ? "?date=" + date : ""))
            .then((res) => res.json())
            .then((result) => {
            ...
            <>
                <div className="bg-white w-full flex-center p-8 paddingBottom p-60">
                    ...
                    <div style={subSection} className="text-sm my-4">
                        This measure uses the highest and lowest prices of the day.
                    </div>
                        ...
                        <div className="flex flex-apart text-black">
                                ...
                                <LocalizationProvider dateAdapter={AdapterDateFns}>
                                    <DesktopDatePicker
                                        ...
                                        onChange={(newValue) => {
                                            ...
                                            this.getIndustriesMostVolatility(format(newValue, "yyyy-MM-dd"))
                                        }}
                            ...
                            <div className="flex flex-row">
                                ...
                                <div>
                                    ...
                                    {this.state.industriesI.map((v) => {
                                        return <h6 style={content}>{v.intradayMovement} </h6>
                                    })}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container flex-center">
                        <div className="flex flex-apart text-white">
                            <div>
                                ...
                                <div style={subHeading} className="text-sm my-4">
                                    Here’s the industries receiving the top 3 number of company mentions in WSJ
                                    articles.{" "}
                                </div>
                            </div>
                            <div className="flex flex-row">
                                ...
                                <div>
                                    ...
                                    {this.state.industriesII.map((v) => {
                                        return <h6 style={content}>{v.numMentions} </h6>
                                    })}
                                </div>
                            </div>
                        </div>
                ...
                <div className="bg-blue text-white w-full flex-center p-8 padding p-60">
                    ...
                    <div className="container flex-center">
                        <div className="flex flex-apart text-white">
                            <div>
                                <div style={Heading} className="text-lg my-4">
                                    Industry performance yesterday
                                </div>
                                <div style={subHeading} className="text-sm my-4">
                                    Based on yesterday’s performance of companies in the particular industries, we sort
                                    them based on best to worst performance.
                                </div>
                            </div>
                            <div className="flex flex-row">
                                <div>
